...
<header id="header">
    ...
    <div class="head3 he3" style="font-weight: 600;">
        <div class="container">
            <div class="row nav " style="margin: 13px 0;">
                <div class="col-md-12 d-flex  justify-content-around item">
                    <a class="tag" href="<?php echo base_url('Intro');?>">INTRODUCTION</a>
                    <a class="tag" href="<?php echo base_url('');?>">PROFILE</a>
                    <a class="tag" href="<?php echo base_url('appointment');?>">APPOINTMENTS</a>
