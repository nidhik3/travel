...
<section
    style="background-image: url('assets/images/banner.webp');height: 35vh;background-size: cover; position:relative">
    <div class="banner">
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="card cardd ">
                    ...
                    <p class=" text-center ml-4 mt-2 mb-2" style="font-weight: 450; font-size:23px">Tele Consultation: +91234567890
                    </p>
                    <a class="text-center  ml-4 " href="<?php echo base_url('#');?>">Click For OPD Consultation</a>
