...
<div class="container h-100 mt-4">
    <div class="row">
        <div class="col-md-6">
            <h4 class="text-center">Introduction about SIG</h4>
            <p>
               ...
               <br> It was also the first private hospital of the state to be recognized for super specialty DNB training course by
                 Medical Council of India and presently admits two candidates per year for superspeciality training in Gastroenterology. <br>
                ...
                Today, the department stands tall with 35-bed dedicated Gastroenterology Ward for oretically ill. <br>
                The department is equipped with state-of-the-art endoscopy suite, 24/7 availability of doctor, 
                availability of four endoscopy suites, a dedicated Gastroenterology ICU and two separate Gastroenterology Wards. <br>
                The Department caters to all gastro-intestinal, hepatic and pancreatico-billary disorders with round the clock emergency OPD,
                emergency and ICU services for the critically ill patients.
                It is a high volume tertiary care center for simple to complex and complicated gastrointestinal disease.
            </p>
        </div>


        <div class="col-md-5 mt-md-3 mt-2  ml-5 app ">
            ...
            <div class="col-md5 mt-md-3 mt-2" style="justify-content: center;align-items: center" ;>
                ...
                <p class="text-center mt-4" style="font-weight: 500; ">Tumor Board Consultation:
