...
<body>
    ...
    <header id="header" class="header d-flex align-items-center addclass nav-down" style="   width:100%;">
        ...
        <div class="container-fluid container-xl d-flex align-items-center row p-0" style="max-width: 100%;margin: auto;">
            <a href="<?php echo base_url(); ?>"
                class="logo d-flex align-items-center col-md-4 col-6 justify-content-center">
                <!-- 
            ...
            <nav id="navbar" class="navbar col-md-12" style="background-color: rgba(0, 0, 0, 0.5);">
                ...
                <ul  class="item"   style="width: 100%; justify-content: center;">
                    ...
                    <li> <a class="tag" href="<?php echo base_url('');?>">GALLERY</a></li>
